      ...
      items: [
        {
          ...
          status: 'I created this website while carrying out testcom where I created an inventory website where this website was created with ExpressJs for the back-end then VueJs for the Front-end and Flutter for Mobile',
          tech: 'VueJs, ExpressJs, Flutter',
          github: 'https://github.com/alvinrahmatmaulana1/IVENTORY',
          demo: 'null'
        },
        {
          id: 2,
          ...
          status: 'I created this website when I was learning Vuejs',
          tech: 'VueJS',
          github: 'https://github.com/alvinrahmatmaulana1/belanja-vuex',
          demo: 'null'
        },
