      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-3xl mb-3 fadein-up"
            src="/img/alvin.jpg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Alvin Rahmat Maulana. I am a web developer from Bandung, armed with knowledge from a vocational school majoring in Software Engineering (RPL). I have experience in creating or maintaining applications or websites, especially on the back-end/server side. I am also someone who is disciplined and works hard at work
          </p>
        </div>
