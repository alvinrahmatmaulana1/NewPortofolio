<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Alvin Rahmat Maulana</h1>
      <div class="py-2">
        <h1
      ...
      <button @click="downloadCV" class="fadein-bot fade-500 flex items-center py-2 px-4 mx-auto text-sm font-medium rounded-lg border transition duration-300 md:py-2.5 md:px-5 md:mx-0 text-amber-200 border-amber-200 hover:bg-amber-200 hover:bg-opacity-10 bg-transparent focus:outline-none w-fit">
...
export default {
  ...
  data() {
    return {
      toRotate: [ "Jr.Back-end Web Developer"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
